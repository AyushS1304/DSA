// Optimal Approach to find the minimum cost to make two baskets equal
// LeetCode 2620: Minimum Cost to Make Two Arrays Equal
// Time Complexity: O(n log n) 
// Space Complexity: O(n)
// where n is the total number of fruits in both baskets
import java.util.*;
